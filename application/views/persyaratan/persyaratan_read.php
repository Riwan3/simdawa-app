							...
							<tbody>
								...
								foreach ($persyaratan as $p): ?>
									<tr>
										...
										<td><?= $p->keterangan ?></td>
										<td>
											<a href="<?= base_url('persyaratan/ubah/' . $p->id) ?>" class="btn btn-sm btn-info">
												<i class="fas fa-edit"></i> Ubah
											</a>
											<a href="<?= base_url('persyaratan/hapus/' . $p->id) ?>" class="btn btn-sm btn-danger" onclick="return confirm('Ingin menghapus data ini?')">
